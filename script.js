require([
  ...
  "dojo/domReady!"
], function(Map, MapView, FeatureLayer, Legend, Graphic, GraphicsLayer, SimpleFillSymbol, SimpleMarkerSymbol, Polygon, Point, BasemapGallery) {
  ...
  var featureLayer1 = new FeatureLayer({
    url: "https://services2.arcgis.com/bB9Y1bGKerz1PTl5/arcgis/rest/services/Deer_Creek_Watershed_Geodatabase_WFL1/FeatureServer/3",
    opacity: 0.6,
    outFields: ["*"],
...
graphicsLayer.add(polygonGraphic);
   var popupTemplate = {
    ...
    content: "<b>{title}</b><br>{description}" // Customize the popup content here
  };
